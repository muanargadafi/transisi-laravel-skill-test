    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('Input Name') }}" value="{{ old('name', @$employee->name) }}" required>
            ...
            <div class="row mb-3">
             ...
             <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="email" name="email" id="email" class="form-control" placeholder="{{ __('Input Email') }}" value="{{ old('email', @$employee->email) }}" required>
